            ...
            <div class="card">
                ...
                <div class="card-body">
                    <dl class="row mb-0">
                        ...
                        <dd class="col-sm-8">{{ $student->user->username }}</dd>
                        ...
                        <dd class="col-sm-8">
                            <span class="badge {{ $student->user->is_active ? 'bg-success' : 'bg-secondary' }}">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <dl class="row mb-0">
                        ...
                        <dd class="col-sm-9">{{ $student->gender == 'L' ? 'Laki-laki' : 'Perempuan' }}</dd>
